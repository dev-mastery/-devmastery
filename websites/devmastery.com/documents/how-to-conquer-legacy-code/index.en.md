...
type: Post
author: Bill Sourour
datePublished: July 31, 2016
image: legacy-code.png
imageDescription: "A swordsman on a horse atop a hill in silhouetter"
category: Articles
summary: "What to fo when you're handed a piece of legacy code — code and asked to learn it, fix it, and add new features."
...
![*_“Yeah, so that ‘quick fix’ to the legacy code actually broke everything and I’m not sure why. Ciao!”_*](https://cdn-images-1.medium.com/max/1600/1*P7oCy28AjxYcIv8F_Wbo3w.gif)
...
source: [UML 2 Sequence Diagrams: An Agile Introduction](http://agilemodeling.com/artifacts/sequenceDiagram.htm)*](https://cdn-images-1.medium.com/max/1600/0*OKAdzneO7BJkr_QW.)

_Sample UML sequence diagram.&nbsp;  
source: [UML 2 Sequence Diagrams: An Agile Introduction](http://agilemodeling.com/artifacts/sequenceDiagram.htm)_
...
_I have often played this song on repeat to get myself in the right mood while tweaking legacy code. It really works._
...
![*Not this kind of adapter pattern (this won’t work, in case you were wondering)*](https://cdn-images-1.medium.com/max/1600/1*mCss9lg7sm43hARTj3Jo3w.jpeg)
