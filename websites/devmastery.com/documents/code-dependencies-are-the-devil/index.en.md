...
image: devil.jpg
category: Articles
summary: One of the biggest risks to the long term stability of your code is how you use and manage all its dependencies. Here's why and what you can do about it.
tags:
  - programming
  - software
  - design
...
topic: Handling code dependencies
type: Post
---
...
![Alice falling down the rabbit hole](./images/alice.gif)
...
![Obiwan Kenobe and Anakin Skywalker, trapped.](./images/obiwan.gif)
_Don’t worry, by the end of this article, you’ll find a new hope._
...
_Adapter pattern diagram from [Dofactory.com](http://www.dofactory.com/javascript/adapter-design-pattern)_
...
_Dependency graph for [TinyTag explorer](http://www.tarind.com/depgraph.html)_
